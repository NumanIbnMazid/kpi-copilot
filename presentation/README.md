...
**Live deck:** https://claude.ai/artifact/MWabc1rgdhQZWEmzm9Auyn

It is private until you share it from the page's Share menu — nobody else can open the link
until you do. The page can present, page through and export.

Speaker notes are attached to each slide in the deck itself. The outline below is for
rehearsing away from a screen.
...
|---|---|---|
| 1 | One way of counting | This is about consistency, not automation |
| 2 | The problem | The comparability problem is worse than the time cost |
| 3 | What it produces | Show the real note. This slide does more work than any other |
| 4 | Fixed vs varies | The left column is why it is worth doing at company level; the right is why anyone will adopt it |
...
comparability anyway — two teams on the same tracker still count differently. Slide 5.
...
Send [docs/01-Overview.md](../docs/01-Overview.md) beforehand, and
[docs/08-Rollout-Playbook.md](../docs/08-Rollout-Playbook.md) afterwards.
